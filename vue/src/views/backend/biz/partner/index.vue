      ...
      <el-col :span="24">
        <el-card>
          <el-row :gutter="20">
            ...
            <el-col :lg="4" :md="4" :sm="12" :xl="4" :xs="12">
              <el-date-picker v-model="queryParams.endTime" clearable
                              placeholder="请选择截止时间" type="date"
    ...
    <el-dialog :title="form.title" v-model="form.visible" destroy-on-close width="40%">
      <el-form ref="formRef" :model="form.data" :rules="rules" label-width="80px">
        ...
        <el-form-item label="截止时间" prop="endTime">
          <el-date-picker v-model="form.data.endTime" placeholder="请选择截止时间"
                          type="date"
                          value-format="YYYY-MM-DD HH:mm:ss"/>
        </el-form-item>
...
const handleSave = () => {
  formRef.value.validate(valid => {
    if (!valid) return
    savePartner(form.value.data).then(res => {
      if (res.code !== 200) {
